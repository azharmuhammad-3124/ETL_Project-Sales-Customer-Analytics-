...
def fetch_postgres():
    engine = create_engine("zoomcamp_project://airflow:airflow@postgres:5432/airflow")
    query = "SELECT * FROM g_customer_report"
...
dag = DAG(
    ...
    catchup=False,
    description='Zoomcamp Porject DAG by Azhar Muhammad',
)
